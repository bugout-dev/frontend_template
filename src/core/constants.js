...
export const DEFAULT_METATAGS = {
  title: "Change me in constants.js",
  description: "change me in constants.js",
  keywords: "change me in constants.js",
...
*/
export const WHITE_LOGO_W_TEXT_URL = `logo/url`;

/*
White Logo URL (.svg)
*/
export const WHITE_LOGO_SVG = `logo/url`;
...
*/
export const COPYRIGHT_NAME = "simiotics.com";
