...
const useTerminus = ({
  ...
  console.log("useTerminus", diamondAddress, targetChain);
  ...
  const terminusBackendStateCache = useQuery(
    ["terminusBackendStateCache", diamondAddress, targetChain.chainId],
    () => getTerminus(diamondAddress, targetChain.chainId),
    {
      ...queryCacheProps,
      retry: false,
